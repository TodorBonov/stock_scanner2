...
and reports/problems_with_tickers.txt. Data is stored for testing and for step 04.
"""
import json
import argparse
...
from config import DEFAULT_ENV_PATH, PREPARED_FOR_MINERVINI, PROBLEMS_WITH_TICKERS, REPORTS_DIR
...
def main():
    ...
    with open(PROBLEMS_WITH_TICKERS, "w", encoding="utf-8") as f:
        f.write("# Problems with tickers (generated by 03_prepare_for_minervini.py)\n")
