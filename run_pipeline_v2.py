"""
Run the complete Pipeline V2: 01 → 02 → 03 → 04 V2 → 05 V2 → 06 V2 → 08.
...
def main():
    parser = argparse.ArgumentParser(description="Run complete Pipeline V2 (01 → 02 → 03 → 04 V2 → 05 V2 → 06 V2 → 08)")
